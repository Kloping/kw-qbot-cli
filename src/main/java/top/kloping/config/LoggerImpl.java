...
public class LoggerImpl implements Logger {
    ...
    public static final Color NORMAL_COLOR = new Color(174, 175, 165, 247);
    public static final Color INFO_COLOR = new Color(1, 193, 58, 247);
    public static final Color DEBUG_COLOR = new Color(225, 185, 0, 247);
    public static final Color ERROR_COLOR = new Color(204, 0, 54, 247);
